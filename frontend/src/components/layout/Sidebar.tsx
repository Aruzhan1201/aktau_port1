...
const allNavItems: NavItem[] = [
  ...
  { labelKey: 'queue', path: ROUTES.QUEUE, icon: ListOrdered, roles: ['admin', 'port_manager', 'super_admin'] },
  { labelKey: 'assignments', path: ROUTES.ASSIGNMENTS, icon: Link2, roles: ['admin', 'super_admin'] },
  ...
  // Admin / Super-admin
  { labelKey: 'deals', path: ROUTES.DEALS, icon: Handshake, roles: ['admin', 'super_admin', 'governance'] },

  // Client
  { labelKey: 'clientDashboard', path: ROUTES.CLIENT_DASHBOARD, icon: Send, roles: ['client'] },
  ...
  // Driver
  { labelKey: 'driverDashboard', path: ROUTES.DRIVER_DASHBOARD, icon: LayoutDashboard, roles: ['driver'] },
  { labelKey: 'parkingSpots', path: ROUTES.PARKING_SPOTS, icon: ParkingCircle, roles: ['driver'] },
  { labelKey: 'deals', path: ROUTES.DEALS, icon: Handshake, roles: ['driver'] },

  // Captain
  { labelKey: 'captainDashboard', path: ROUTES.CAPTAIN_DASHBOARD, icon: LayoutDashboard, roles: ['captain'] },
  ...
  // Parking Manager
  { labelKey: 'parkingZones', path: ROUTES.PARKING_ZONES, icon: Car, roles: ['parking_manager'] },
  { labelKey: 'parkingSpots', path: ROUTES.PARKING_SPOTS, icon: ParkingCircle, roles: ['parking_manager'] },
  ...
  // Ro-Ro
  { labelKey: 'roRo', path: ROUTES.RO_RO, icon: Truck, roles: ['admin', 'super_admin'] },
  { labelKey: 'roRoAnalytics', path: ROUTES.RO_RO_ANALYTICS, icon: BarChart3, roles: ['admin', 'super_admin', 'governance'] },
